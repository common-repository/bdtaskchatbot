...
if(isset($_GET['active_id'])):
        ...
        global $d;
         $delete_data= BDTASKCHATBOT_Departmentsmappings::bdtaskchatbot_department_map_delete($active_id);
 ...
 <?php 
    if(isset($_POST['add_department_mapping'])):
    if(isset( $_POST['d_mapping_name_nonce'] ) && wp_verify_nonce($_POST['d_mapping_name_nonce'], 'd_mapping_action_nonce')){
       global $departmentmap ; 
       $departmentmap = BDTASKCHATBOT_Departmentsmappings::bdtaskchatbot_process_department_map_data();
        ...
        ?>
         ...
         <div class = "col-sm-12" style="display:block;">
          <?php if($departmentmap['action_status'] == 'no_error_data_save_successfully'): ?> 
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <?php echo esc_html('Department maping save successfully!','bdtaskchatbot');?>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <div class="col-sm-12">
            <div class="card" style="width:100%!important;max-width:100%!important;">
                ...
                <div class="card-body">
                    ...
                    <form action="" class="form-inner" method="post" id="department_mapping" accept-charset="utf-8">
                    <?php wp_nonce_field("d_mapping_action_nonce","d_mapping_name_nonce");?>
                        <div class="form-group row">
                            <label for="department_id"  id="department_id" class="col-sm-2 col-form-label"><?php echo esc_html('Department Name','bdtaskchatbot');?> <i class="text-danger">*</i></label>
                            <div class="col-sm-10">
                               <?php
                               ...
                               ?>
                                <select name="department_id" class="form-control">
                                    <option value="" selected="selected"><?php echo esc_html('Select Option','bdtaskchatbot');?></option>
                                 <?php
                                
                                
                                 foreach ($department_names as $department_name) {
                                 ?>
                                    <option value="<?php echo  $department_name->department_id;?>"><?php echo  $department_name->department_name;?></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select name="user_id" class="form-control" id="user_id">
                                    ...
                                    <option value="<?php echo $username->ID?>"><?php echo esc_html($username->user_nicename);?></option>
                                    <?php }?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <button type="reset" class="btn btn-danger w-md m-b-5"><?php echo esc_html('Reset','bdtaskchatbot');?></button>
                                <button type="submit" class="btn btn-success w-md m-b-5"  name="add_department_mapping"><?php echo esc_html('Create','bdtaskchatbot');?></button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        $department_map_list = $wpdb->get_results( $department_map_query['query']['select_all'], OBJECT ) ;
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo wp_nonce_url(admin_url('admin.php?page=bdtaskchatbot_update_mapping&id='.$value->id),'bdtaskchatbot_action_qtns', 'bdtaskchatbot_qtns_nonce'); ?>" class="mr-1" title="Edit Department"><i class="fa fa-1x fa-edit text-info"></i></a>
